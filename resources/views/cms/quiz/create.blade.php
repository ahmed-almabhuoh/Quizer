@extends('cms.parent')
@section('title', __('cms.create_quiz'))
@section('big-title', __('cms.create_quiz'))
@section('small-title', __('cms.create_quiz'))
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('cms.create_quiz') }}</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="create-form">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="mark" placeholder="Enter quiz mark">
                                </div>
                                <div class="form-group">
                                    <label for="time">{{ __('cms.time_in_minutes') }}</label>
                                    <input type="number" class="form-control" id="time" placeholder="Enter quiz time">
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <!-- select -->
                            ...
                            <div class="card-footer">
                                <button type="button" onclick="applyAddingQuiz()"
...
@section('scripts')
    <script>
        function applyAddingQuiz() {
            axios.post('/cms/admin/quizzes', {
